...
@Named("addProductBean")
@SessionScoped
public class AddProductMBean implements Serializable{
	...
	public String save(){
		...
		try
		{
			...
			catalogFacadeRemote.addProduct(categoryToSend, name, brandToSend, modelToSend, dailyPrice, description);
